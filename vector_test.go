...
func TestCreateVectorXNumber(t *testing.T) {
	vector := sat.Vector{15.12312, 12312.1}
...
func TestVectorCopy(t *testing.T) {
	vector1 := sat.Vector{15.12312, 12312.1}
	vector2 := sat.Vector{}
...
func TestVectorNormalize(t *testing.T) {
	vector := sat.Vector{41, 123.123}
	vector2 := vector.Normalize()
	assert.Equal(t, float64(1), vector2.Len(), "length should be 1")
}
func TestVectorAdd(t *testing.T) {
	vector1 := sat.Vector{15, 5}
	vector2 := sat.Vector{25, 45}
